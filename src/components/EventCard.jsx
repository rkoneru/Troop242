...
/**
 * EventCard Component
 * Isolates the high-frequency countdown timer to prevent full-page re-renders.
 *
 * Performance Impact:
 * Reduces re-renders of the Home page from every 1 second to only when necessary.
 */
