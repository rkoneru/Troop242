  ...
  return (
    <>
      ...
      <section
        ...
        style={{ minHeight: "30vh", paddingTop: "3rem", paddingBottom: "3rem" }}
      >
            ...
            >
                ...
                <input
                  ...
                  onFocus={(e) => {
                    ...
                    e.target.style.boxShadow =
                      "0 0 0 3px rgba(100, 150, 200, 0.2)";
                  }}
                  onBlur={(e) => {
              ...
              <button
                ...
                style={{
                  padding: "12px 24px",
                  background:
                    "linear-gradient(135deg, var(--bg-secondary), var(--accent))",
                  color: "var(--text-primary)",
                  border: "none",
                  borderRadius: 8,
                  fontWeight: 600,
                ...
                onMouseEnter={(e) => {
                  if (!loading) {
                    e.target.style.boxShadow =
                      "0 6px 24px rgba(100, 150, 200, 0.3)";
                ...
                onMouseLeave={(e) => {
                  if (!loading) {
                    e.target.style.boxShadow =
                      "0 4px 16px rgba(100, 150, 200, 0.2)";
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  All accounts are secured with encryption and require
              ...
              >
                ...
                >
                  Access your account from any device. The member portal is
                  fully responsive and works on all screens.
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  troop242sanford@gmail.com or call on Tuesday at 7:00 PM.
                </p>
              </div>
            </div>
          </motion.div>
