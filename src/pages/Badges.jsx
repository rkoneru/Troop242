...
// ⚡ Bolt Optimization: Hoist static Framer Motion animation variants to module scope.
// This prevents recreation of these objects on every single render, preserving stable references.
...
export default function Badges() {
  ...
  // ⚡ Bolt Optimization: Memoize the filtered categories list computation.
  // This avoids re-running the extensive map/filter logic across all 140+ badges
  // when selectedCategory toggles or other unrelated states change.
