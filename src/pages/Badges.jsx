...
// Animation variants moved outside component to prevent recreation on every render
...
export default function Badges() {
  ...
  // Performance Optimization: Memoize the filtered categories list.
  // This prevents expensive nested mapping/filtering on every render (e.g. when toggling categories).
