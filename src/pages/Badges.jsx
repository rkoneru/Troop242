...
export default function Badges() {
  ...
  // Performance: Memoize filtered categories to prevent re-filtering
  // the entire 140+ badge list during category expansion/collapse.
  const filteredCategories = useMemo(() => {
    if (searchTerm.trim() === '') return BADGE_CATEGORIES;
    ...
    return BADGE_CATEGORIES
      .map(cat => ({
        ...
        badges: cat.badges.filter(badge =>
          badge.name.toLowerCase().includes(lowerSearch)
        )
      }))
      .filter(cat =>
