...
// Define variants outside the component to prevent unnecessary object recreation on each render
...
export default function Badges() {
  ...
  // Performance Optimization (Bolt ⚡): Use useMemo to prevent expensive filtering on every render.
  // Re-calculates ONLY when searchTerm changes, not when toggling category expansion.
