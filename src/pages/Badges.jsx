...
// Hoist static Framer Motion variants to the module scope to preserve stable references
// and avoid recreating them on every component re-render.
...
export default function Badges() {
  ...
  // Memoize the expensive category/badge search & filter logic (over 140+ badges).
  // This prevents recalculating the filtered list on every state change (such as selectedCategory toggles).
