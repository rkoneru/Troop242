...
export default function Badges() {
  ...
  // Performance: Memoize filtered categories to prevent re-calculating on every UI state change
  // This avoids processing ~150 badges when users expand/collapse categories
