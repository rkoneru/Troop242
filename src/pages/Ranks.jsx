...
// Performance Optimization: Hoist static Framer Motion variants outside component definition
// to prevent re-creating objects on every render cycle and ensure stable prop references.
      ...
      <section className="hero-page section">
        <div className="container">
          ...
          >
            ...
            >
              Progress through seven ranks from Scout to Eagle Scout. Each rank
              represents growth in leadership, outdoor skills, and character
              development.
            </p>
            <motion.a
      ...
      <section className="section">
        <div className="container">
          <motion.div
            ...
            style={{ gap: 32 }}
          >
            {/* Performance Optimization: Use stable unique key (rank.name) instead of array index */}
            {RANKS.map((rank, i) => (
              <motion.div
                key={rank.name}
              ...
              >
                ...
                >
                  <div style={{ fontSize: "3.5rem", flexShrink: 0 }}>
                    {rank.emoji}
                  </div>
                  <div style={{ flex: 1 }}>
                ...
                <div style={{ marginBottom: 24 }}>
                  ...
                  >
                    {rank.requirements.map((req) => (
                      <div key={req} style={{ fontSize: "0.95rem" }}>
                        • {req}
                      </div>
                    ))}
                  </div>
          ...
          >
            ...
            >
              ...
              <p style={{ color: "var(--text-muted)", marginBottom: 24 }}>
                Most scouts reach Eagle rank within 4-5 years of dedication,
                consistent attendance, and personal growth. The average age for
                Eagle Scout is 16.
              </p>
              <motion.a
