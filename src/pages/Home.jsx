...
// Event Card Component with Internal Timer to prevent full-page re-renders
...
// Hoisted animation variants to avoid re-creation on every render
    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          >
            {events.map((event, i) => (
              <EventCard key={i} event={event} variants={itemVariants} />
            ))}
          </motion.div>
        </div>
      </section>
