...
// Static animation variants hoisted to module scope to prevent re-creation on every render
...
// Did You Know Carousel Component - Memoized to prevent re-renders from Home state changes
const DidYouKnowCarousel = memo(() => {
...
DidYouKnowCarousel.displayName = 'DidYouKnowCarousel';

// Flip Card Component - Memoized to prevent re-renders from Home state changes
const WhyUsCard = memo(({ icon: Icon, title, desc }) => {
...
export default function Home() {
  ...
  // Event data with dates - memoized to prevent unnecessary re-calculations
