...
// Performance-optimized animation variants hoisted to module scope to prevent re-creation
...
// Did You Know Carousel Component - Memoized to prevent parent re-renders
const DidYouKnowCarousel = memo(function DidYouKnowCarousel() {
...
// Flip Card Component - Memoized to prevent parent re-renders
const WhyUsCard = memo(function WhyUsCard({ icon: Icon, title, desc }) {
...
// Optimized Event Card Component - Isolates the 1s countdown timer to prevent page-level re-renders
    ...
    >
      <div className="event-card-inner">
        <div className="event-card-front" style={{ borderColor: event.featured ? 'var(--accent)' : 'var(--accent-dim)' }}>
          ...
          {/* Countdown Timer - Isolated inside EventCard for performance */}
          {countdown && (
