...
// Event Card Component with isolated countdown timer
const EventCard = memo(({ event }) => {
  const [countdown, setCountdown] = useState(null);
  const formattedDate = useMemo(() => event.date.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }), [event.date]);
