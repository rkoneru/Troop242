...
// Events Section Component - Isolated to prevent whole-page re-renders on countdown updates
function EventsSection({ itemVariants, containerVariants }) {
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* EVENTS SECTION */}
      <EventsSection itemVariants={itemVariants} containerVariants={containerVariants} />
