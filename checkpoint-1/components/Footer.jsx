      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div className="footer-section">
            ...
            <p style={{ color: '#9ca3af', fontSize: '0.9rem', lineHeight: 1.6, maxWidth: '1500px' }}>
        ...
        <div className="footer-grid">
          ...
          <div className="footer-section">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div className="footer-contact-item">
                <Phone size={16} style={{ color: '#00d68f' }} />
       ...
       <div style={{ textAlign: 'center', marginTop: 32, paddingTop: 24, borderTop: '1px solid rgba(255, 255, 255, 0.05)' }}>
          <FooterLink to="/appearance" style={{ fontSize: '0.85rem', color: '#9ca3af', transition: 'color 0.2s' }}>
            🎨 Appearance
          </FooterLink>
        </div> 

        {/* Divider & Copyright */}
        <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.05)', marginTop: 40, paddingTop: 24 }}>
