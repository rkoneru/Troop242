      ...
      <section className="section section--dark" style={{ minHeight: '60vh', display: 'flex', alignItems: 'center' }}>
        <div className="container">
          ...
          >
            ...
            <motion.p variants={itemVariants} style={{ fontSize: '1.1rem', color: '#9ca3af', maxWidth: 600, margin: '0 auto' }}>
      ...
      <section className="section">
        <div className="container">
          ...
          >
            ...
            <p style={{ fontSize: '1.1rem', color: '#9ca3af', marginBottom: 32, maxWidth: 600, margin: '0 auto 32px' }}>
