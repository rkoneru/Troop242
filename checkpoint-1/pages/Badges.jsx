      ...
      <section className="hero-v2 section" style={{ minHeight: '55vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
        <div className="container">
          ...
          >
            ...
            <p style={{ fontSize: '1.1rem', color: '#9ca3af', maxWidth: 700, margin: '0 auto' }}>
        ...
        <div className="container">
          ...
          >
            <div className="glass-card" style={{ padding: 40 }}>
              ...
              <ol style={{ color: '#9ca3af', lineHeight: 1.8, fontSize: '0.95rem' }}>
        ...
        <div className="container">
          {filteredCategories.length > 0 ? (
            ...
            >
              {filteredCategories.map((catItem, i) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.02, borderColor: 'rgba(0, 214, 143, 0.5)' }}
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: '0.85rem', color: '#9ca3af' }}>{catItem.badges.length} badges</p>
                    </div>
                  </div>
                  ...
                  >
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12, paddingTop: 16, borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
                  ...
                  <div style={{ marginTop: 16, textAlign: 'center' }}>
                    ...
                    >
                      <ArrowRight size={18} style={{ color: '#00d68f' }} />
                    </motion.div>
                  </div>
                </motion.div>
              ))}
            ...
            <div style={{ textAlign: 'center', padding: '40px 0' }}>
              <p style={{ color: '#9ca3af', fontSize: '1.1rem' }}>No badges found matching "{searchTerm}"</p>
            </div>
          )}
        </div>
      </section>
          ...
          >
            <div className="glass-card" style={{ padding: 40 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 24 }}>
                <div>
                  <h4 style={{ fontSize: '1.1rem', marginBottom: 12, color: '#00d68f' }}>140+ Badges</h4>
                  <p style={{ color: '#9ca3af', lineHeight: 1.6 }}>
                    Choose from a wide variety of merit badges covering skills, hobbies, and interests.
                  </p>
                </div>
                <div>
                  <h4 style={{ fontSize: '1.1rem', marginBottom: 12, color: '#00d68f' }}>Rank Progress</h4>
                  <p style={{ color: '#9ca3af', lineHeight: 1.6 }}>
                    Earn required badges to advance ranks and work toward the prestigious Eagle Scout rank.
                  </p>
                </div>
                <div>
                  <h4 style={{ fontSize: '1.1rem', marginBottom: 12, color: '#00d68f' }}>Skill Development</h4>
                  <p style={{ color: '#9ca3af', lineHeight: 1.6 }}>
