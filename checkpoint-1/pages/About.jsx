            ...
            >
              {[
                ...
                <motion.div
                  ...
                  style={{ padding: 24 }}
                >
                  <item.icon size={32} style={{ color: '#00d68f', marginBottom: 12 }} />
                  <h3 style={{ marginBottom: 8 }}>{item.title}</h3>
                  <p style={{ color: '#9ca3af', fontSize: '0.9rem' }}>{item.description}</p>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 32 }}>
              {[
                ...
                >
                  ...
                  <h4 style={{ marginBottom: 4, color: '#00d68f', fontSize: '0.85rem', textTransform: 'uppercase', fontWeight: 700 }}>
                    {leader.role}
                  </h4>
                  <h3 style={{ marginBottom: 8 }}>{leader.name}</h3>
                  <p style={{ fontSize: '0.85rem', color: '#9ca3af', marginBottom: 12, fontWeight: 500 }}>
                    {leader.experience}
                  </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 24 }}>
              {[
                ...
                >
                  ...
                  <h3 style={{ color: '#00d68f', marginBottom: 8 }}>{stat.number}</h3>
      ...
      <section className="section section--dark">
        <div className="container">
          ...
          >
            ...
            <p style={{ fontSize: '1.05rem', color: '#d1d5db', lineHeight: 1.8, marginBottom: 32 }}>
